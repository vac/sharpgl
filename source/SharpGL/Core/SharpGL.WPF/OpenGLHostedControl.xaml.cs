...
{
    /// <summary>
    /// Interaction logic for OpenGLHostedControl.xaml
    /// </summary>
    public partial class OpenGLHostedControl : UserControl
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenGLHostedControl"/> class.
        /// </summary>
        public OpenGLHostedControl()
        {
            InitializeComponent();
        ...
        private void OpenGLControl_Loaded(object sender, RoutedEventArgs routedEventArgs)
        {
            ...
            {
                //  Create OpenGL.
                gl.Create(OpenGLVersion, RenderContextType.NativeWindow, 1, 1, 32, canvas.Handle);
            }
        ...
        {
            //  Get the control.
            OpenGLHostedControl me = o as OpenGLHostedControl;
        ...
        private static readonly DependencyProperty FrameRateProperty =
          DependencyProperty.Register("FrameRate", typeof(double), typeof(OpenGLHostedControl),
        ...
        private static readonly DependencyProperty OpenGLVersionProperty =
          DependencyProperty.Register("OpenGLVersion", typeof(OpenGLVersion), typeof(OpenGLHostedControl),
        ...
        private static readonly DependencyProperty DrawFPSProperty =
          DependencyProperty.Register("DrawFPS", typeof(bool), typeof(OpenGLHostedControl),
